...
export const CLUB_META = {
  ...
  verdy: m({
    ...
    official: { hp: 'https://www.verdy.co.jp/', x: 'https://x.com/TokyoVerdySTAFF', instagram: 'https://www.instagram.com/tokyo_verdy/', shop: null },
  ...
  grampus: m({
    ...
    official: { hp: 'https://nagoya-grampus.jp/', x: 'https://x.com/nge_official', instagram: 'https://www.instagram.com/nagoyagrampus_official/', shop: 'https://shop.nagoya-grampus.jp/' },
  ...
  gamba: m({
    ...
    official: { hp: 'https://www.gamba-osaka.net/', x: 'https://x.com/GAMBA_OFFICIAL', instagram: 'https://www.instagram.com/gambaosaka_official/', shop: 'https://shop.gamba-osaka.net/' },
  ...
  cerezo: m({
    ...
    official: { hp: 'https://www.cerezo.jp/', x: 'https://x.com/crz_official', instagram: 'https://www.instagram.com/cerezo_osaka/', shop: 'https://shop.cerezo.jp/' },
  ...
  sanfrecce: m({
    ...
    official: { hp: 'https://www.sanfrecce.co.jp/', x: 'https://x.com/sanfrecce_SFC', instagram: 'https://www.instagram.com/sanfrecce_official/', shop: 'https://shop.sanfrecce.co.jp/' },
  ...
  avispa: m({
    ...
    official: { hp: 'https://www.avispa.co.jp/', x: 'https://x.com/avispaf', instagram: 'https://www.instagram.com/avispafukuoka_official/', shop: 'https://shop.avispa.co.jp/' },
  ...
  kyoto: m({
    ...
    official: { hp: 'https://www.sanga-fc.jp/', x: 'https://x.com/sangafc', instagram: 'https://www.instagram.com/kyotosanga_official/', shop: 'https://shop.sanga-fc.jp/' },
  ...
  machida: m({
    ...
    official: { hp: 'https://www.zelvia.co.jp/', x: 'https://x.com/FCMachidaZelvia', instagram: 'https://www.instagram.com/fcm_zelvia/', shop: 'https://shop.zelvia.co.jp/' },
  ...
  chiba: m({
    ...
    official: { hp: 'https://jefunited.co.jp/', x: 'https://x.com/jef_united', instagram: 'https://www.instagram.com/jefunited_official/', shop: 'https://shop.jefunited.co.jp/' },
  ...
  mito: m({
    ...
    official: { hp: 'https://www.mito-hollyhock.net/', x: 'https://x.com/hollyhock_staff', instagram: 'https://www.instagram.com/mitohollyhock/', shop: 'https://shop.mito-hollyhock.net/' },
  ...
  okayama: m({
    ...
    official: { hp: 'https://www.fagiano-okayama.com/', x: 'https://x.com/fagiano_koho', instagram: 'https://www.instagram.com/fagianookayama/', shop: 'https://shop.fagiano-okayama.com/' },
  ...
  nagasaki: m({
    ...
    official: { hp: 'https://www.v-varen.com/', x: 'https://x.com/v_varenstaff', instagram: 'https://www.instagram.com/vvarennagasaki_official/', shop: 'https://shop.v-varen.com/' },
