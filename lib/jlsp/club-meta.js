...
export const CLUB_META = {
  ...
  kashima: m({
    ...
    official: {
      hp: 'https://www.so-net.ne.jp/antlers/',
      x: 'https://x.com/atlrs_official',
      instagram: 'https://www.instagram.com/kashima_antlers/',
      shop: 'https://shop.kashima-antlers.co.jp/',
    },
    mascot: {
      name: 'シカオ・ファミリー',
  ...
  fctokyo: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/ft/',
  }),
  verdy: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/tv/',
  }),
  reysol: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/re/',
  }),
  grampus: m({
    descriptionLong:
  ...
  gamba: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/gb/',
  }),
  cerezo: m({
    descriptionLong:
    ...
    mascot: { name: 'ロビー', description: '桜の精霊をモチーフにしたピンクのキャラクター。' },
  ...
  kobe: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/vk/',
  }),
  sanfrecce: m({
    descriptionLong:
    ...
    mascot: { name: 'サンチェ・フレッチェ', description: '紫のキャラクターたち。三本の矢を体現する家族。' },
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/sf/',
  }),
  avispa: m({
    descriptionLong:
    ...
    mascot: { name: 'アビー・ビビーくん', description: 'スズメバチをモチーフにしたコンビ。攻撃的なクラブ像を表現。' },
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/av/',
  }),
  kyoto: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/ky/',
  }),
  machida: m({
    descriptionLong:
  ...
  chiba: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/jc/',
  }),
  mito: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/mt/',
  }),
  shimizu: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/si/',
  }),
  okayama: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/oy/',
  }),
  nagasaki: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/nv/',
  }),
  ...
  tosu: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/sa/',
  }),
  shonan: m({
    descriptionLong:
    ...
    mascot: { name: 'キングベルくん', description: '湘南の海を象徴するキャラクター。' },
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/be/',
  }),
  iwata: m({
    descriptionLong:
  ...
  niigata: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/al/',
  }),
  yokohamafc: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/yfc/',
  }),
  omiya: m({
    descriptionLong:
    ...
    mascot: { name: 'アルディ・ミーヤ', description: 'リスのコンビ。大宮公園のリス舎にも由来する。' },
  ...
  sendai: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/se/',
  }),
  yamagata: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/yt/',
  }),
  akita: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/bb/',
  }),
  kofu: m({
    descriptionLong:
  ...
  tokushima: m({
    ...
    mascot: { name: 'ヴォルタくん', description: '徳島の渦潮を象徴する青いキャラクター。' },
  ...
  fujieda: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/fy/',
  }),
  hachinohe: m({
    descriptionLong:
  ...
  imabari: m({
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/im/',
  }),
  tegevajaro: m({
    descriptionLong:
    ...
    ticketUrl: 'https://www.jleague-ticket.jp/club/te/',
  }),
  'tochigi-city': m({
    descriptionLong:
