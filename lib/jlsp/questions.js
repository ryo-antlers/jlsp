 ...
 *
 * category: shoubu | keiei | rank | history | stadium | style | passion | fanculture | visual | region
 */
export const QUESTIONS = [
  // ===== 勝負観 =====
  { id: 'q25', category: 'shoubu', legacyAxis: 'shoubu', direction: +1, statement: 'どんなに良い試合でも、応援するチームが負けたら観た意味がない。' },
  { id: 'q29', category: 'shoubu', legacyAxis: 'shoubu', direction: -1, statement: '結果だけの勝利より、中身の伴った試合にこそ価値を感じる。' },
  ...
  { id: 'q05', category: 'shoubu', legacyAxis: 'shoubu', direction: +1, statement: '全力で勝負して負けるより、手加減されて勝つ方が嬉しい。' },
  { id: 'q21', category: 'shoubu', legacyAxis: 'shoubu', direction: -1, statement: '勝った試合より、負けた試合の方が得るものが大きいと思う。' },
  { id: 'q41', category: 'shoubu', legacyAxis: 'shoubu', direction: +1, statement: 'ホームのボールボーイは、自チームに有利に動いていい。' },
  { id: 'u14', category: 'shoubu', statement: '勝つためなら、時間稼ぎくらい当然だと思う。' },
  { id: 'u16', category: 'shoubu', statement: '好きなチームがフェアプレー賞なんてもらっても嬉しくない。' },

  // ===== 経営: 補強 ⇔ 育成 =====
  { id: 'q26', category: 'keiei', legacyAxis: 'keiei', direction: +1, statement: 'スター選手を獲得できる資金力のあるクラブが羨ましい。' },
  { id: 'q42', category: 'keiei', legacyAxis: 'keiei', direction: +1, statement: '日本代表や海外でプレーしていた有名な選手を応援したい。' },
  { id: 'q18', category: 'keiei', legacyAxis: 'keiei', direction: +1, statement: '無名の若手より、実績のある完成された選手がいる方が安心だ。' },
  { id: 'q02', category: 'keiei', legacyAxis: 'keiei', direction: +1, statement: 'チームの弱点は、育てるより即戦力の補強で埋めるべきだ。' },
  ...
  // ===== クラブの格・野心 =====
  { id: 'c4', category: 'rank', statement: '地元かどうかに関係なく、強くて好きなクラブを選んで応援していい。' },
  { id: 'b4', category: 'rank', statement: '当日でもふらっと行ってチケットが買えるクラブを好きになりたい。' },
  ...
  // ===== スタジアム =====
  { id: 'a1', category: 'stadium', statement: 'スタジアムは駅から近い方がいい。長く歩くのは避けたい。' },
  { id: 'a3', category: 'stadium', statement: '陸上トラックのない、ピッチが近い球技専用スタジアムで観たい。' },

  // ===== プレースタイル・戦術 =====
  { id: 'h1',  category: 'style', statement: '失点を恐れず、攻撃的に殴り合うサッカーが観たい。' },
  { id: 'h3',  category: 'style', statement: 'ボールを保持して相手を圧倒する、ポゼッションサッカーが好きだ。' },
  { id: 'h6',  category: 'style', statement: 'ロングボールやセットプレーを武器にするサッカーも魅力的だ。' },
  { id: 'u13', category: 'style', statement: '華麗なテクニックよりも、力強いタックルの方に興奮する。' },

  // ===== 観戦の熱量・関わり方 =====
  { id: 'q35', category: 'passion', legacyAxis: 'kansen', direction: +1, statement: 'スタンドの熱が、ピッチ上の選手を動かしていると信じている。' },
  { id: 'u6',  category: 'passion', statement: '試合中にトイレに立つなんて、考えられない。' },

  // ===== サポーター文化 =====
  { id: 'u5',  category: 'fanculture', statement: 'ゴール裏で応援するなら、前の人の旗で試合が見えなくても構わない。' },
  { id: 'u10', category: 'fanculture', statement: 'ブーイングという文化が、あまり好きではない。' },
  { id: 'u11', category: 'fanculture', statement: 'スタジアムに来てくれたアウェイのサポーターには、特別な歓迎をしたい。' },
